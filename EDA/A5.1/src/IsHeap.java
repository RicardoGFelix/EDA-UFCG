...
class IsHeap {
    ...
    public static void main(String[] args) {
        ...
        String input = Arrays.toString(convertedInput);

        Heap heap = new Heap(convertedInput.length);
        heap.buildHeap(convertedInput);

        System.out.println(isHeap(input, heap.toString()));
    }
    ...
    private static boolean isHeap(String input, String heap) {
        return input.equals(heap);
    }
